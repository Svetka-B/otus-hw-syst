...
1. PostgreSQL 16 — основная СУБД.
2. Patroni — управление кластером, автоматический выбор лидера (failover) и восстановление.
3. etcd 3.4 (3 узла, на db-1..db-3) — распределённое хранилище состояния (DCS) для Patroni.
4. HAProxy (на backend-1, backend-2) — балансировщик с разделением трафика:
