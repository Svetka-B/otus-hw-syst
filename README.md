...
3. Установка и настройка Logstash c помощью Ansible роли logstash:
...
4. Установка и настройка Kibana c помощью Ansible роли kibana.
 - Установка Kibana с зеркала Яндекс;
 - Настройка конфигурации Kibana с указанием хостов Elasticsearch;
5. Установка и настройка Filebeat на бэкенд и фронтенд хосты c помощью Ansible роли filebeat.
